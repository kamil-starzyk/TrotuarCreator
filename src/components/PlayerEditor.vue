    ...
    <div v-show="panelVisible">
      ...
      <p>
        ...
        <textarea
          ...
          @input="(event) => handleUpdate(event, 'description')"
        ></textarea>
      </p>
      <p>
        Lvl:
        <input
          :value="player.lvl"
          @input="(event) => handleUpdate(event, 'lvl', true)"
          type="number"
          class="numeric_input"
        />
      </p>
      <p>
        ...
        <input
          :value="player.exp"
          @input="(event) => handleUpdate(event, 'exp', true)"
          type="number"
          class="numeric_input"
        />
      </p>
      <p>
        ...
        <input
          :value="player.weight"
          @input="(event) => handleUpdate(event, 'weight', true)"
          type="number"
          class="numeric_input"
        />
      </p>
      <p>
        ...
        <input
          :value="player.money"
          @input="(event) => handleUpdate(event, 'money', true)"
          type="number"
          class="numeric_input"
        />
      </p>
      <p>
        ...
        <select
          :value="player.race"
          @input="(event) => handleUpdate(event, 'race')"
        >
      ...
      <p>
        ...
        <select
          ...
          @input="(event) => handleUpdate(event, 'proficiency')"
        >
      ...
      <p>
        HP max
        <input
          :value="player.params.hp_max"
          @input="(event) => handleUpdate(event, 'params.hp_max', true)"
          type="number"
          class="numeric_input"
        />
        HP
        <input
          type="range"
          min="0"
          :max="player.params.hp_max"
          :value="player.params.hp"
          @input="(event) => handleUpdate(event, 'params.hp', true)"
        />{{ player.params.hp }}
      </p>
      ...
      <p>
        Stamina total
        <input
          :value="player.params.stamina_total"
          @input="(event) => handleUpdate(event, 'params.stamina_total', true)"
          type="number"
          class="numeric_input"
        />
        TODO Stamina max
        ...
        <input
          type="range"
          min="0"
          :max="player.params.stamina_max"
          :value="player.params.stamina"
          @input="(event) => handleUpdate(event, 'params.stamina', true)"
        />{{ player.params.stamina }}
      </p>

      <p>
        Mana max
        <input
          :value="player.params.mana_max"
          @input="(event) => handleUpdate(event, 'params.mana_max', true)"
          type="number"
          class="numeric_input"
        />
        Mana
        <input
          type="range"
          min="0"
          :max="player.params.mana_max"
          :value="player.params.mana"
          @input="(event) => handleUpdate(event, 'params.mana', true)"
        />{{ player.params.mana }}
      </p>
      ...
      <p>
        Satiation max
        <input
          :value="player.params.satiation_max"
          @input="(event) => handleUpdate(event, 'params.satiation_max', true)"
          type="number"
          class="numeric_input"
        />
        Satiation
        <input
          type="range"
          min="0"
          :max="player.params.satiation_max"
          :value="player.params.satiation"
          @input="(event) => handleUpdate(event, 'params.satiation', true)"
        />{{ player.params.satiation }}
      </p>

      <p>
        Hydration max
        <input
          :value="player.params.hydration_max"
          @input="(event) => handleUpdate(event, 'params.hydration_max', true)"
          type="number"
          class="numeric_input"
        />
        Hydration
        <input
          type="range"
          min="0"
          :max="player.params.hydration_max"
          :value="player.params.hydration"
          @input="(event) => handleUpdate(event, 'params.hydration', true)"
        />{{ player.params.hydration }}
      </p>
      ...
      <p>
        defence:
        <input
          :value="player.stats.defence"
          @input="(event) => handleUpdate(event, 'stats.defence', true)"
          type="number"
          class="numeric_input"
        />
      </p>
      <p>
        ...
        <input
          ...
          @input="(event) => handleUpdate(event, 'stats.speed', true)"
          type="number"
          class="numeric_input"
        />
      </p>
      <p>
        ...
        <input
          ...
          @input="(event) => handleUpdate(event, 'stats.dexterity', true)"
          type="number"
          class="numeric_input"
        />
      </p>
      <p>
        ...
        <input
          ...
          @input="(event) => handleUpdate(event, 'stats.endurance', true)"
          type="number"
          class="numeric_input"
        />
      </p>
